...
const ProfileSidebar = ({ navigation, onClose }) => {
    ...
    const renderFeatureCard = ({ item }) => (
        <View style={styles.card}>
            <Icon name={item.icon} size={50} color="#FFA500" />
    ...
    return (
        <View style={styles.sidebar}>
            ...
            {/* About the App Row */}
            <TouchableOpacity style={styles.infoRow} onPress={handleOpenModal}>
                <View style={styles.infoRow}>
                    <Icon name="info-outline" size={20} color="#555" />
                    <Text style={[styles.infoText, { fontWeight: '600' }]}>About the App</Text>
                </View>
            </TouchableOpacity>
